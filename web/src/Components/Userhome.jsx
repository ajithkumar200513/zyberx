...
const UserHome = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await fetch(`https://ak-solutions-services.netlify.app/Ak_Web/UserAccess/postdata/${User.userid}`, {
      method: 'POST',
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await fetch(`https://ak-solutions-services.netlify.app/Ak_Web/UserAccess/getdata/${User.userid}`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${User.token}`

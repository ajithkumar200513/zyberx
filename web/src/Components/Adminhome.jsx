...
const Adminhome = () => {
  ...
  const handleBtnClick = async (value) => {
    const response = await fetch(`https://main--merry-kulfi-9e7cd0.netlify.app/Ak_Web/Admin/getdata/${value}`, {
      method: 'GET',
      headers: {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await fetch(`https://main--merry-kulfi-9e7cd0.netlify.app/Ak_Web/Admin/getdata/`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${Admin.token}`
  ...
  const handleApprove = async (e, value) => {
    ...
    try {
      const response = await fetch(`https://main--merry-kulfi-9e7cd0.netlify.app/Ak_Web/Admin/updatedata/${value}`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${Admin.token}`
